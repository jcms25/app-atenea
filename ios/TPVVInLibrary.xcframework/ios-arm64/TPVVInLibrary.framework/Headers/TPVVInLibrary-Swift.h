...
SWIFT_CLASS("_TtC13TPVVInLibrary13PaymentMethod")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull transfer;)
+ (NSString * _Nonnull)transfer SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull domiciliation;)
+ (NSString * _Nonnull)domiciliation SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull immediatePayment;)
+ (NSString * _Nonnull)immediatePayment SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, SDK, open) {
  SDKVersion = 0,
};
...
@property (nonatomic, copy) NSString * _Nonnull appMerchantPayMethods;
