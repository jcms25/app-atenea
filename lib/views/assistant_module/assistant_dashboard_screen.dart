...
class AssistantDashboardChild extends State<AssistantDashboard> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        // ✅ Bug A fix: SingleChildScrollView evita el overflow (barras negras/amarillas)
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Consumer<AssistantController>(
                  builder: (context, assistantController, child) {
                    String profileImage =
                        assistantController.assistant?.userImage ?? "";
                        ...
                        children: [
                          ...
                          Builder(builder: (context) {
                            ...
                            return Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(Icons.assignment_ind, color: AppColors.white.withValues(alpha: 0.8), size: 18),
                                Text('Asistencia',
                                    style: AppTextStyle.getOutfit300(
                                        textSize: 11,
              ...
              GestureDetector(
                onTap: () {
                  Provider.of<AssistantController>(context, listen: false)
                      .setCurrentBottomIndexSelected(
                          currentBottomIndexSelected: 1);
                },
                child: Container(
                  height: 100,
                  decoration: BoxDecoration(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Consumer<AssistantController>(
                                builder:
                                    (context, assistantController, child) {
                                  return Text(
                                    assistantController
