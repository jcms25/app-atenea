...
//                         ),
//                         const Spacer(),
//                         Image.asset(AppImages.whiteAppLogo,
//                             width: 50, height: 50)
//                       ],
//                     )
//                   ],
...
//       icon: SvgPicture.asset(AppImages.dashboard,
//           colorFilter: const ColorFilter.mode(Colors.grey, BlendMode.srcIn)),
//       label: '',
//       activeIcon: SvgPicture.asset(AppImages.dashboard,
//           colorFilter:
//               const ColorFilter.mode(AppColors.primary, BlendMode.srcIn)),
//     ),
//     BottomNavigationBarItem(
//       icon: SvgPicture.asset(AppImages.circular,
//           colorFilter: const ColorFilter.mode(Colors.grey, BlendMode.srcIn)),
//       label: 'Circular Icon',
//       activeIcon: SvgPicture.asset(AppImages.circular,
//           colorFilter:
//               const ColorFilter.mode(AppColors.primary, BlendMode.srcIn)),
//     ),
//     BottomNavigationBarItem(
...
//       ),
//       label: 'people',
//       activeIcon: SvgPicture.asset(AppImages.calender,
//           colorFilter:
//               const ColorFilter.mode(AppColors.primary, BlendMode.srcIn)),
//     ),
//     BottomNavigationBarItem(
...
//       ),
//       label: 'people',
//       activeIcon: SvgPicture.asset(AppImages.event,
//           colorFilter:
//               const ColorFilter.mode(AppColors.primary, BlendMode.srcIn)),
//     ),
//   ];
...
//           colorFilter: const ColorFilter.mode(Colors.grey, BlendMode.srcIn)),
//       label: 'video',
//       activeIcon: SvgPicture.asset(AppImages.message,
//           colorFilter:
//               const ColorFilter.mode(AppColors.primary, BlendMode.srcIn)),
//     ),
//     BottomNavigationBarItem(
...
//                     className: studentData.userdata.className ?? "",
//                     studentName: studentData.userdata.sFname ?? "",
//                     roleType: 0))
//           ];
//         }
...
//         if (e['name'] == "Envíos del Profesor" && roleType != 1) {
//           continue;
//         } else {
//           DrawerMenuOption drawerMenuOption = DrawerMenuOption.fromJson(e);
...
//                       drawerMenuOption.classId ?? "",
//                       drawerMenuOption.studentWpId ?? "",
//                       className: drawerMenuOption.className ?? "",
//                     )));
//         break;
//       case 'Alumnos':
...
//                       cid: drawerMenuOption.classId ?? "",
//                       wpId: drawerMenuOption.studentWpId ?? "",
//                       studentName: drawerMenuOption.studentName ?? "",
//                     )));
//         break;
...
//             context,
//             MaterialPageRoute(
//                 builder: (context) => ChildCommunicationListScreen(
//                     studentWpUserId: drawerMenuOption.studentWpId ?? "")));
//         break;
//       default:
//     }
//   }
