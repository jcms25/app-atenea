...
class TeacherDetails extends StatefulWidget {
  ...
  const TeacherDetails({super.key,required this.id,required this.subject,required this.inCharge, });
  ...
  void callAPI() async {
    ...
    try{
      ...
      setState(() {
        ...
        dynamic country = await ApiClass().getSingleTeacher(loginModel?.basicAuthToken ?? "",widget.id,loginModel?.userdata?.cookies ?? "");
        if(country['status']){
