...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      storeController?.getProductList(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: TextField(
                onChanged: (query) =>
                    storeController?.searchInProductList(query),
                decoration: InputDecoration(
                  ...
                  ScrollConfiguration(behavior: ScrollBehavior().copyWith(overscroll: false), child: Consumer<StoreController>(
                    builder: (context, storeController, child) {
                      return GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ProductItem product =
                          storeController.filterProducts[index];
                          return ProductCard(product: product);
                        },
                      );
                    },
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    //     ? product.prices?.priceRange != null
                    //         ? "${AppConstants.formatPrice(double.tryParse(product.prices?.priceRange?.minAmount ?? "0.0") ?? 0.0)} - ${AppConstants.formatPrice(double.tryParse(product.prices?.priceRange?.maxAmount ?? "0.0") ?? 0.0)}"
                    //         : AppConstants.formatPrice(
                    //             double.tryParse(product.prices?.price ?? "0") ??
                    //                 0,
                    //           )
                    //     : "",
                    ...
                    product.variations?.isNotEmpty ?? false
                        ...
                        : AppConstants.formatPrice(double.parse(
                            "${product.prices?.regularPrice ?? 0.0}")),
              ...
              child: SizedBox(
                ...
                child:
                  ...
                  builder: (context, storeController,
                    ...
                    bool isLoading =
                        storeController.isProductLoading("${product.id ?? 0}");
                    ...
                    return ElevatedButton(
                          ...
                          : () async {
                              if (product.variations?.isNotEmpty ?? false) {
                                ...
                                await storeController.addToCart(
                                    ...
                                    fromProductListOrFromDetails: 1);
                              }
                            },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.primary,
                      ...
                      child: isLoading
                          ? CircularProgressIndicator(
                              color: AppColors
                                  .white) // ✅ Show loader while adding to cart
                          : Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
